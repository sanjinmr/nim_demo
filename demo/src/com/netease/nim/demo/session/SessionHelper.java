...
public class SessionHelper {
    ...
    public static void init() {
        ...
        // 启动单聊：NimUIKit.startChatting(context, account, SessionTypeEnum.P2P, sessionCustomization);
        // 启动群聊：NimUIKit.startChatting(context, teamId, SessionTypeEnum.Team, sessionCustomization);
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
    ...
    /**
     * 会话窗口消息列表提供一些点击事件的响应处理函数，见 SessionEventListener:
     * 1、头像点击事件处理，一般用于打开用户资料页面
     * 2、头像长按事件处理，一般用于群组@功能，或者弹出菜单，做拉黑，加好友等功能
     */
